...
export const loadBannerAction =
  (id: string) => async (dispatch: Dispatch<BannerActionTypes>) => {
...
export const loadRecentBannersAction =
...
export const loadBrowsedBannersAction =
  (placeId: string | null, filter: BannerFilter, page: number) =>
  async (dispatch: Dispatch<BannerActionTypes>) => {
    if (page === 0) {
      dispatch({
...
export const loadSearchBannersAction =
  (searchTerm: string, filter: BannerFilter, page: number) =>
  async (dispatch: Dispatch<BannerActionTypes>) => {
    if (page === 0) {
      dispatch({
...
export const loadAgentBannersAction =
  (agentName: string, filter: BannerFilter, page: number) =>
  async (dispatch: Dispatch<BannerActionTypes>) => {
    if (page === 0) {
      dispatch({
...
export const loadUserBannerListBannersAction =
  (listType: BannerListType, filter: BannerFilter, page: number) =>
  async (dispatch: Dispatch<BannerActionTypes>) => {
    if (page === 0) {
      dispatch({
...
export const submitBannerAction =
  () =>
  async (dispatch: Dispatch<BannerActionTypes>, getState: () => RootState) => {
...
export const editBannerAction =
  (banner: Banner) => (dispatch: Dispatch<BannerActionTypes>) => {
    dispatch({
      type: EDIT_BANNER,
      payload: banner,
    })
...
export const changeBannerSettingsAction =
  (banner: Banner, bannerSettings: BannerSettings) =>
  async (dispatch: Dispatch<BannerActionTypes>) => {
